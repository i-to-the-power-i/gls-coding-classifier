...
threshold_file = "hyperparameter-tuning/breast-cancer/best_threshold.npy"
...
classifier = GLSCompressionClassifier(n_classes, threshold=best_threshold, alpha=1, fast_mode=True)
...
output_folder = "test-results/breast-cancer/"
...
# Print results
print("\nTest Results (Breast Cancer Dataset):")
...
for class_label in range(n_classes):
    ...
    filename = f"second_return_skew_tent_map_bcw_class_{class_label}.png"
