...
threshold_file = "hyperparameter-tuning/ionosphere/best_threshold.npy"
...
output_folder = "test-results/ionosphere/"
...
# Print results
print("\nTest Results (ionosphere Dataset):")
...
for class_label in range(n_classes):
    ...
    filename = f"second_return_skew_tent_map_ionosphere_class_{class_label}.png"
