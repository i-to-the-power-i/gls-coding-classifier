...
threshold_file = "hyperparameter-tuning/haberman/best_threshold.npy"
...
output_folder = "test-results/haberman/"
...
for class_label in range(n_classes):
    ...
    filename = f"second_return_skew_tent_map_haberman_class_{class_label}.png"
