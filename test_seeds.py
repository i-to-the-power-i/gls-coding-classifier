...
threshold_file = "hyperparameter-tuning/seeds/best_threshold.npy"
...
output_folder = "test-results/seeds/"
...
for class_label in range(n_classes):
    ...
    filename = f"second_return_skew_tent_map_seeds_class_{class_label}.png"
